...
namespace ExpertSystem.Tests.DAL.Entities
{
	...
	public class StorageCustomSocketTest
	{
		...
		public void Serialize_isCorrect()
		{
			...
			// Act
			var actualLine = StorageCustomSocket.Serialize(inputSocket);
		...
		public void Deserialize_line_isCorrect()
		{
			...
			// Act
			var actualSocket = StorageCustomSocket.Deserialize(inputLine);
		...
		public void Deserialize_parts_isCorrect()
		{
			...
			// Act
			var actualSocket = StorageCustomSocket.Deserialize(inputParts);
