...
namespace ExpertSystem.Tests.DAL.Entities
{
	public class CsvEntityTest
	{
		...
		private readonly WalEntry _testEntryInsert;
		private readonly WalEntry _testEntryUpdate;
		private readonly WalEntry _testEntryDelete;
		...
		public CsvEntityTest(ITestOutputHelper output)
		{
			...
			_testEntryInsert = new WalEntry(CsvDbAction.Insert, _testSocket.GetHashCode(), _testSocket);
			_testEntryUpdate = new WalEntry(CsvDbAction.Update, _testSocket.GetHashCode(), _testSocket);
			_testEntryDelete = new WalEntry(CsvDbAction.Delete, _testSocket.GetHashCode());
			_testCsvLine = 
